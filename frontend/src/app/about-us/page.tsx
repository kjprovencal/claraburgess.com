              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div className="text-center md:text-left">
                  ...
                  <p className="text-gray-600 leading-relaxed mb-4">
                    Natalie is the heart of our family, bringing warmth, creativity, and endless love to everything she does. 
                    Her nurturing spirit and gentle nature make her the perfect mother-to-be.
                  </p>
                  <p className="text-gray-600 leading-relaxed mb-4">
            ...
            <div className="max-w-4xl mx-auto">
              <div className="grid md:grid-cols-2 gap-8 items-center">
                ...
                <div className="text-center md:text-left order-1 md:order-2">
                  ...
                  <p className="text-gray-600 leading-relaxed mb-4">
                    Kyle is the rock of our family, providing strength, stability, and unwavering support. 
                    His protective nature and loving heart make him the perfect father-to-be.
                  </p>
                  <p className="text-gray-600 leading-relaxed mb-4">
                  ...
                  <p className="text-gray-600 leading-relaxed">
                    ...
                    Clara will grow up feeling safe, loved, and always entertained!
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="grid md:grid-cols-3 gap-6">
                <div className="text-center p-6 bg-gradient-to-br from-pink-50 to-pink-100 rounded-xl border border-pink-200">
                  ...
                  <h3 className="text-lg font-semibold text-gray-800 mb-2">Unconditional Love</h3>
                  <p className="text-gray-600 text-sm">
                    We believe in loving Clara for exactly who she is, supporting her dreams, and being her biggest cheerleaders.
                  </p>
                </div>
